...
class MyStrategy(TradingStrategy):
    ...
    def backtest(self, data):
        ...
        data['position'] = 0
        data['position'][z_scores < -self.z_entry_threshold] = 1  # Buy signal
        data['position'][z_scores > self.z_exit_threshold] = -1   # Sell signal
        ...
        # Calculate final portfolio value after backtesting period
